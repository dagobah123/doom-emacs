...
`(hl-line ((t (:foreground ,text-hl :background ,background ))))
...
`(lazy-highlight ((t (:foreground ,text-normal :background unspecified ))))
`(line-number ((t (:foreground ,text-low :background unspecified ))))
`(line-number-current-line ((t (:foreground ,text-normal :background unspecified :bold t ))))
...
`(lsp-face-highlight-read ((t (:foreground ,text-highlight-2 :background unspecified :bold t ))))
`(lsp-face-highlight-write ((t (:foreground ,text-normal :background unspecified ))))
...
`(swiper-line-face ((t (:foreground ,text-match-1 :background ,background-match-1 :bold t ))))
...
`(diredfl-dir-name ((t (:foreground ,text-normal :background unspecified :bold t ))))
